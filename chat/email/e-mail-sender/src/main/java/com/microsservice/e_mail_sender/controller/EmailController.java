...
public class EmailController {
	...
	@PostMapping("/find")
	public ResponseEntity<EmailRequest> findByEmail(@RequestBody EmailRequest request) throws BadRequestException{
		EmailRequest user = service.findByEmailAndVerify(request);
